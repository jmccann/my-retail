...
test('increase quantity', () => {
  ...
  wrapper.find('Button.quantity-increase').simulate('click');
...
test('decrease quantity', () => {
  ...
  wrapper.find('Button.quantity-increase').simulate('click');
  expect(wrapper.find('input').props().defaultValue).toBe(2);
  wrapper.find('Button.quantity-decrease').simulate('click');
  expect(wrapper.find('input').props().defaultValue).toBe(1);
});
...
it('disables decrease button by default', () => {
  const wrapper = mount(<Quantity />);
  expect(wrapper.find('Button.quantity-decrease').props().disabled).toBe(true);
});
...
it('enables decrease button when greater then 1', () => {
  ...
  wrapper.find('Button.quantity-increase').simulate('click');
  expect(wrapper.find('input').props().defaultValue).toBe(2);
  expect(wrapper.find('Button.quantity-decrease').props().disabled).toBe(false);
});
